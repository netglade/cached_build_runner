...
import 'core_models/user.dart' as _i3;
import 'core_models/user_dto.dart' as _i2;

/// {@template package:example/user_mappr.dart}
/// Available mappings:
/// - `UserDto` → `User`.
/// {@endtemplate}
class $UserMappr implements _i1.AutoMapprInterface {
  ...
  /// {@macro package:example/user_mappr.dart}
  @override
